...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// La petición en el siguiente formato: application/x-www-form-urlencoded (POSTMAN)
		// Utilizando en el body x-www-form-urlencoded escribimos como clave y valor lo siguiente nombre=tony&password=1234
		response.setContentType("application/json");
		response.setCharacterEncoding("UTF-8");
		//Permitir acceso desde distintos dominios
		response.addHeader("Access-Control-Allow-Origin", "*");
